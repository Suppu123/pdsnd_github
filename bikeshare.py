...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        city_name = input("\nWhat is the name of the city to analyze the data? (E.g. Enter either chicago, new york city, washington)\n")
        if city_name.lower() in CITY_DATA:
            ...
            print("Sorry we were unable to recognize the name of the city to analyze data, Please input either chicago, new york city or washington.\n")
